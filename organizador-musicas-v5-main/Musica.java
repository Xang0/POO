...
public class Musica
{
    ...
    // A quantidade de vezes que uma musica e tocada
    ...
    private void definirDetalhes(String artista, String titulo, String nomeDoArquivo)
    {
        ...
        numeroDeExecucoes = numeroDeExecucoes;
    }
    
    /**
     * Reinicia a contagem de execuçoes para zero
     */
    public void reiniciarContagemExecucoes()
    {
        numeroDeExecucoes = 0;
    }
     ...
     */
    public void incrementaContagemExecucoes()
    {
        numeroDeExecucoes += 1;
    }
}
